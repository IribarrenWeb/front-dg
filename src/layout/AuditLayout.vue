<template>
  <div>
    <div class="container py-5">
      <base-steps containerClassess="border rounded border-ligth" listClasses="p-3 nav-fill" :audit="true"
        :steps="steps" @navigate="handleNavigate" :currentStep="currentStep" :meta="true" :id="audit.id"></base-steps>
      <div class="p-3 mt-3 border rounded border-ligth">
        ...
        <router-view v-slot="{ Component, route }" v-else>
          <transition name="fade">
            <keep-alive>
              <component :is="Component" :key="route.path" :audit="audit" @next="handleNext" @prev="handlePrev"
