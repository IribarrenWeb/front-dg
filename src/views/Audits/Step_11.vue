<template>
    <form-validate @submit="onSubmit" v-slot="{ meta }">
        ...
        <div v-else class="row justify-content-center px-md-2">
            <div class="col-md-12">
                <h4 class="text-uppercase">INFORME DE RESULTADOS DE LA VISITA TÉCNICA</h4>
                <div class="row">
                    <div class="col-md-12 mt-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <base-field name="type" label="Tipo">
                                        <field-validate as="select" class="form-control" name="type" label="tipo" v-model="non_c.type_id" rules="required">
                                            <option selected>Tipo</option>
                                            <option
                                                :value="idx"
                                                v-for="(type, idx) in audit.non_types"
                                                :key="idx"
                                                >
                                                {{ type.name }}
                                            </option>
                                ...
                                <div class="col-md-3">
                                    <base-field name="priority" label="Prioridad">
                                        <field-validate as="select" class="form-control" name="priority" label="prioridad" v-model="non_c.pri_id" rules="required">
                                            <option selected>Prioridad</option>
                                            <option
                                                :value="idx"
                                                v-for="(pri, idx) in audit.pri_types"
                                                :key="idx"
                                                >
                                                {{ pri.name }}
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <base-field name="description" label="Descripción">
                                        <field-validate type="text" class="form-control" name="description" rules="required" label="descripción" v-model="non_c.description"/>
                                    </base-field>
                                </div>
                        ...
                        <div class="col-md-12 mt-md-3">
                            <base-field label="OBSERVACIONES GENERALES VISITA INSTALACIÓN">
                                <textarea class="form-control" cols="30" rows="10" v-model="general_observations"></textarea>
                            </base-field>
                        </div>
                        <div class="col-md-12 mt-md-3">
                            <h6 class="text-uppercase text-muted">NIVEL DE CUMPLIMIENTO</h6>
                            <div class="col-md-6">
                                <base-field name="level" label="VALORACIÓN CUMPLIMIENTO NORMATIVA ADR MERCANCÍAS PELIGROSAS EVALUACIÓN GENERAL">
                                    <field-validate as="select" class="form-control" name="level" label="nivel de cumplimiento" v-model="level" rules="required">
                                        <option selected>Nivel de cumplimiento</option>
                                        <option
                                            :value="level.id"
                                            v-for="(level, idx) in audit.levels"
                                            :key="idx"
                                            >
                                            {{ level.name }}
                                        </option>
