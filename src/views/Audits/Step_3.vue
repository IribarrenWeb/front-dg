				...
				<div class="col-md-12 mt-md-3">
							...
							<div class="col-md-3">
								<base-field name="adr_class_id" label="Clase ADR">
									<field-validate
										...
										name="adr_class_id"
										label="clase"
										v-model="audit_materials.adr_class_id"
										rules="required"
									>
							...
							<div class="col-md-3">
								<base-field name="packing_group_id" label="GE">
									<field-validate
										...
										label="ge"
										v-model="audit_materials.packing_group_id"
										rules="required"
									>
							...
							<div class="col-md-4">
								<base-field name="comment" label="Comentario">
									<field-validate
										...
										rules="required"
										label="comentario"
										v-model="audit_materials.comment"
									/>
								</base-field>
							</div>
					...
					<div class="row" v-for="(material, idx) in materials" :key="idx">
						<div class="col-md-3">
							<base-input
								:view="true"
								:modelValue="material.class.code"
								disabled
							/>
						</div>
						<div class="col-md-3">
							<base-input
								:view="true"
								:modelValue="material.packing.code"
								disabled
							/>
						</div>
						<div class="col-md-4">
