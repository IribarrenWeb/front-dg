                    ...
                    <div class="col-md-12 mt-md-4">
                        <base-checkbox :checked="checked" @input="check2 = $event">
                            <b >
                                ...
                                Informe correspondiente a la visita realizada por su Consejero de Seguridad designado por la empresa, de acuerdo con las recomendaciones del Ministerio de Fomento, comprobando y revisando aquellos aspectos que figuran como obligatorios en el informe de los Consejeros de Seguridad, según el RD 97/2017
                            </b>
                        </base-checkbox>
                    </div>
                </div>
