					...
					<div class="col-md-12 mt-md-3">
						...
						<form-validate @submit="addVehicle">
							<div class="row">
								...
								<div class="col-md-2">
									<base-input
										:view="true"
										:modelValue="vehicle.fleet != null ? vehicle.fleet : ``"
										label="Flota"
										disabled
									/>
								</div>
								<div class="col-md-2">
									<base-input
										:view="true"
										:modelValue="vehicle.type != null ? vehicle.type.name : ``"
										label="Tipo"
										disabled
									/>
								</div>
								<div class="col-md-3">
									<base-input
										:view="true"
										:modelValue="vehicle.adr != null ? vehicle.adr.code : ``"
										label="Designación"
										disabled
									/>
								</div>
						...
						<div class="row" v-for="(veh, idx) in vehicles" :key="idx">
							<div class="col-md-3">
								<base-input
									:view="true"
									:modelValue="veh.registration_number"
									disabled
								/>
							</div>
							<div class="col-md-2">
