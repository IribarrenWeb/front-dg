<template>
    <div v-if="material != null">
        <div class="d-flex align-items-center">
            <div class="d-flex">
                <img v-for="label in material.material.labels" :key="label.id" class="rounded" :src="label.url" :alt="label.image" width="75">
            </div>
            <div class="ml-md-2 ml-1 row">
                ...
                <span class="text-muted font-weight-light h6 col-12" data-bs-toggle="tooltip" data-bs-placement="top" :title="material.material.denomination_name">
                    {{denomination}}
                </span>
            </div>
        </div>
                ...
                <table class="table table-sm table-bordered rounded">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span data-bs-toggle="tooltip" data-bs-placement="top" :title="material.material.denomination_name">
                                    {{ denomination }}
                                </span>
                            </td>
        ...
        <div class="row mt-md-3 mt-1">
            <div class="col-md-6 border rounded border-light px-md-2 py-md-1">
                <div class="col-12 d-flex justify-content-around align-items-center">
                    ...
                    <base-switch :value="material.is_dangerous == 1 ? true : false" classes="m-0" :disabled="true"></base-switch>
                </div>
            </div>
            <div class="col-md-6 border rounded border-light px-md-2 py-md-1 d-flex align-items-center">
...
export default {
    ...
    methods: {
        async show(id){
            try {
                const res = await service.show('material', id, 'includes[]=installation.operations&includes[]=installation.province.city&includes[]=deposit')
