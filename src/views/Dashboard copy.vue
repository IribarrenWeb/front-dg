  ...
  <div>
    ...
    <div class="container-fluid mt--5">
      ...
      <div class="mt-5">
        <tabs>
          <!-- <card shadow> -->
          <tab-pane icon="ni ni-cloud-upload-96" title="Delegados">
            <page-visits-table></page-visits-table>
          </tab-pane>
          <tab-pane icon="ni ni-bell-55 mr-2" title="Auditores">
            <page-visits-table></page-visits-table>
          </tab-pane>
          <tab-pane icon="ni ni-calendar-grid-58" title="Empresas">
            <page-visits-table></page-visits-table>
          </tab-pane>
          <!-- </card> -->
        </tabs>
