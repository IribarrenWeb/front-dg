<template>
	<div>
		...
		<template v-if="currentStep == 2 && update">
			<div>
				<business-table :byAuditableId="id"/>
			</div>
		</template>
		<template v-if="currentStep == 3 && update">
			<div>
				<installation-table :byAuditableId="id"/>
			</div>
		</template>
	</div>
</template>
...
import InstallationTable from '../../views/Tables/InstallationTable.vue';
import BusinessTable from '../../views/Tables/Business/BusinessTable.vue';
