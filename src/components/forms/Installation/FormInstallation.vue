                    ...
                    <div class="col-lg-4" v-if="ROLE != 'auditor' && ROLE != 'business'">
                        <base-field name="auditable" label="Auditor">
                            <div v-if="model.auditable != null">
                                <span class="mr-md-4 text-uppercase">{{ model.auditable.name }}
                                    {{ model.auditable.last_name }}</span>
                                <base-button @click="model.auditable = null" size="sm" type="default" :outline="true"
                ...
                <div v-if="!isSaved">
                    <div class="row border rounded border-light px-4 py-2">
                        ...
                        <div class="col-lg-6 col-lg-4">
                            <base-field apiName="responsible.name" name="name" label="Nombre">
                                <field-validate :disabled="isSaved" type="text" class="form-control" name="name"
                                    rules="required|alpha_spaces" label="Nombre" v-model="model.responsible.name" />
                            </base-field>
                        </div>

                        <div class="col-lg-6 col-lg-4">
                            <base-field apiName="responsible.last_name" name="last_name" label="Apellido">
                                <field-validate :disabled="isSaved" type="text" class="form-control" name="last_name"
                                    rules="required|alpha_spaces" label="apellido"
                        ...
                        <div class="col-lg-6 col-lg-4">
                            <base-field apiName="responsible.email" name="email" label="Email">
                                <field-validate :disabled="isSaved" type="text" class="form-control" name="email"
                                    rules="required|email" label="email" v-model="model.responsible.email" />
                            </base-field>
                        </div>
                    ...
                    <div class="row border rounded border-light px-4 py-2 mt-3">
                        ...
                        <div class="col-lg-6">
                            <base-field apiName="responsible.file_firm" name="file_firm" label="Documento de Alta">
                                <div v-if="model.responsible.file_firm.file.length >= 1">
                                    ...
                                    <base-button @click="model.responsible.file_firm.file = []" size="sm" type="default"
                                        :outline="true" :disabled="isSaved"><i class="fa-solid fa-pencil"></i>
                                    </base-button>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-2">
                                    <base-switch v-model="model.responsible.dangerous_goods"
                                        :value="model.responsible.dangerous_goods != 0 ? true : false"
                                ...
                                <div v-if="model.responsible.dangerous_goods" class="col-lg-5">
                                    <base-field apiName="responsible.date_certification" name="date_cer"
                                        ...
                                        <field-validate :disabled="isSaved" type="date" class="form-control"
                                            name="date_cer" rules="required" label="fecha"
                                ...
                                <div v-if="model.responsible.dangerous_goods" class="col-lg-5">
                                    <base-field apiName="responsible.file_certification" name="file_cer"
                                        ...
                                        <div v-if="model.responsible.file_certification.file.length >= 1">
                                            <span
                                                class="mr-md-4">{{ model.responsible.file_certification.file[0].name }}</span>
                                        ...
                                        <field-validate :disabled="isSaved" v-else type="file" class="form-control"
                                            name="file_cer" rules="required" label="documento"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3" v-if="model.responsible.driver">
                                    <base-field apiName="responsible.driver_document_date" name="driver_date"
                                        ...
                                        <field-validate :disabled="isSaved" type="date" class="form-control"
                                            name="driver_date" v-model="model.responsible.driver_document_date"
                                            rules="required">
                                        </field-validate>
                                    </base-field>
                                </div>
                                <div class="col-lg-4" v-if="model.responsible.driver">
                                    <base-field apiName="responsible.file_driver" name="file_driver"
                                        ...
                                        <div v-if="model.responsible.driver_document.file.length >= 1">
                                            <span
                                                class="mr-md-4">{{ model.responsible.driver_document.file[0].name }}</span>
                                            <base-button @click="model.responsible.driver_document.file = []" size="sm"
